...
function element_pack_ninja_forms_options() {
    ...
    $data = get_transient( 'ep_ninja_form_options' );
    ...
    if ( false === $data ) {
        ...
        set_transient( 'ep_ninja_form_options', $form_options, MINUTE_IN_SECONDS );
    }
...
function element_pack_caldera_forms_options() {
    ...
    $data = get_transient( 'ep_caldera_form_options' );
    ...
    if ( false === $data ) {
        ...
        set_transient( 'ep_caldera_form_options', $form_options, MINUTE_IN_SECONDS );
    }
...
function element_pack_quform_options() {
    ...
    if ( false === $data ) {
        ...
        set_transient( 'ep_quform_form_options', $form_options, MINUTE_IN_SECONDS );
    }
...
function element_pack_gravity_forms_options() {
    ...
    $data = get_transient( 'ep_gravity_form_options' );
    ...
    if ( false === $data ) {
        ...
        set_transient( 'ep_gravity_form_options', $form_options, MINUTE_IN_SECONDS );
    }
