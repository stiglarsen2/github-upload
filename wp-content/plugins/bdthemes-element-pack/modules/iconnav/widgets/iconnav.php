...
class Iconnav extends Widget_Base {
	...
	public function render_loop_iconnav_list($list) {
		...
		$this->add_render_attribute( 'iconnav-item-link', 'class', 'bdt-icon-nav-icon-wrapper', true );
		...
		<div <# print(view.getRenderAttributeString( 'icon-nav')); #>>
			<div <# print(view.getRenderAttributeString( 'nav-container')); #>>
				...
				<ul class="bdt-icon-nav bdt-icon-nav-vertical">
					...
					view.addRenderAttribute( 'iconnav-item-link', 'class', 'bdt-icon-nav-icon-wrapper', true );
