...
class Advanced_Image_Gallery extends Widget_Base {
	...
	public function get_script_depends() {
		return [ 'imagesloaded', 'bdt-uikit-icons', 'tilt', 'bdt-justified-gallery' ];
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'grid_type',
			[
				'label'   => __( 'Gallery Mode', 'bdthemes-element-pack' ),
				'type'    => Controls_Manager::CHOOSE,
				'options' => [
					'normal' => [
						'title' => __( 'Normal', 'bdthemes-element-pack' ),
						'icon'  => 'eicon-gallery-grid',
					],
					'masonry' => [
						'title' => __( 'Masonry', 'bdthemes-element-pack' ),
