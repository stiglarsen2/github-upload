...
class Audio_Player extends Widget_Base {
	...
	public function render_play_button() {
		...
		<div class="bdt-width-auto" >
			<a href="javascript:;" class="jp-play" tabindex="1" title="<?php esc_html_e('Play', 'bdthemes-element-pack'); ?> <?php echo $settings['title']; ?>">
				<?php echo element_pack_svg_icon('play'); ?>
			</a>
			<a href="javascript:;" class="jp-pause" tabindex="1" title="<?php esc_html_e('Pause', 'bdthemes-element-pack'); ?> <?php echo $settings['title']; ?>">
