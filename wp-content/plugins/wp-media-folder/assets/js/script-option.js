...
(function ($) {
    ...
    var bindSelect = function () {
        ...
        $('#import_button').on('click', function () {
            var $this = $(this);
            $('.wpmf-spiner-import').show().css('visibility', 'visible');
            importFtp($this);
        });
        ...
        $('.wpmf_watermark_exclude_folders').on('click', function () {
            var excludes = [];
            ...
            $('[name="wpmf_watermark_exclude_folders"]').val(excludes.join());
        });
    };
