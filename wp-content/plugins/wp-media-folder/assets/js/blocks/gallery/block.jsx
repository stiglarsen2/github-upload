(function (wpI18n, wpBlocks, wpElement, wpEditor, wpComponents) {
    ...
    class WpmfPortfolioTheme extends Component {
         ...
         */
        unSelectedImage(e) {
            if (!$(e.target).hasClass('wpmf-gallery-image') && !$(e.target).hasClass('hover_img')) {
                this.props.setStateImgSelectedID(0);
                this.props.setStateImgInfos('', '', '');
            }
        }
                                ...
                                return (
                                    <li
                                        ...
                                        <div className={(this.props.selectedImageId === image.id) ? 'wpmf-gallery-block-item-infos is-selected' : 'wpmf-gallery-block-item-infos'}>
                                            {(this.props.gallery_loading) && <span
                                                className="spinner wpmf_spiner_block_gallery_loading"> </span>}
                                            <div onClick={() => this.loadImageInfos(image)} className="hover_img"> </div>
    ...
    class wpmfWordpressGallery extends Component {
        ...
        render() {
            ...
            const {images, display, columns, size, targetsize, link, wpmf_orderby, wpmf_order, autoplay, img_border_radius, borderWidth, borderStyle, borderColor, hoverShadowH, hoverShadowV, hoverShadowBlur, hoverShadowSpread, hoverShadowColor, gutterwidth, wpmf_autoinsert, wpmf_folder_id} = attributes;
