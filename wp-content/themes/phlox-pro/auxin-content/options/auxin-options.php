...
function auxin_define_options_info( $fields_sections_list ){
    ...
    $sections[] = array(
        ...
        'parent'      => 'appearance-section', // section parent's id
        'title'       => __( 'Typography (deprecated)', 'phlox-pro' ),
        'description' => __( 'Typography Setting', 'phlox-pro' )
    );

    $options[] = array(
        'title'       => __( 'Enable Custom Typography', 'phlox-pro' ),
        'description' => __( 'The following options will be deprecated in next version of this theme. Please use new options in `General > General Typography` and `Header > Header Typography`', 'phlox-pro' ),
    ...
    $options[] = array(
        'title'       => __( 'Main Content', 'phlox-pro' ),
        'description' => __( 'Specifies content typography.', 'phlox-pro' ),
    ...
    $options[] = array(
        'title'       => __( 'Main Titles', 'phlox-pro' ),
        'description' => sprintf(__( 'Main titles contain sections and widget titles. %1$sAll %2$sh1%3$s to %2$sh6%3$s typography can be set here.', 'phlox-pro' ), '<br>', '<code>', '</code>'),
    ...
    $options[] = array(
        'title'       => __( 'Page Heading', 'phlox-pro' ),
        'description' => __( 'Specifies main title typography of page.', 'phlox-pro' ),
    ...
    $options[] = array(
        ...
        'description' => __( 'Specifies menu typography.', 'phlox-pro' ),
    ...
    $options[] = array(
        'title'       => __( 'Buttons Typography', 'phlox-pro' ),
        'description' => __( 'Specifies buttons typography.', 'phlox-pro' ),
    ...
    $options[] = array(
        'title'       => __( 'Include Latin Charecters', 'phlox-pro' ),
        'description' => __( 'If there are characters in your language that are not supported in fonts, use following options to load them.', 'phlox-pro' ),
    ...
    $options[] = array(
        ...
        'description' => __( 'Specifies replay title of comment forms.', 'phlox-pro' ),
    ...
    $options[] = array(
        'title'          => __( 'Replay Title Typography', 'phlox-pro' ),
        'description'    => '',
    ...
    $options[] = array(
        'title'          => __( 'Form Button Typography', 'phlox-pro' ),
        'description'    => '',
...
/* ---------------------------------------------------------------------------------------------------
   ...
   --------------------------------------------------------------------------------------------------- */
    ...
    $options[] = array(
        'title'       => __( 'Override Header Template', 'phlox-pro' ),
        'description' => __( 'Enable it to replace header section with an Elementor template.', 'phlox-pro' ),
    ...
    $options[] = array(
        'title'       => __( 'Elementor Header Template', 'phlox-pro' ),
   ...
   $options[] = array(
    ...
    $options[] = array(
        'title'       => __( 'Sticky Header Background Color', 'phlox-pro' ),
    ...
    $options[] = array(
        ...
        'description' => __( 'Set the fullscreen search skin.', 'phlox-pro' ),
    ...
    $options[] = array(
        ...
        'description' => __( 'Enable it to replace single section with an Elementor template.', 'phlox-pro' ),
    ...
    $options[] = array(
        'title'         => __( 'Display post caregories', 'phlox-pro' ),
    ...
    $options[] = array(
        ...
        'choices'       => array(
            'gt' => array(
                'label'     => esc_html__( 'Greater Than (>)', 'phlox-pro' ),
                'css_class' => 'axiAdminIcon-breadcrumb-divider2'
            ),
            'slash' => array(
                'label'     => __( 'Slash', 'phlox-pro' ),
                'css_class' => 'axiAdminIcon-breadcrumb-divider1',
            ),
            'arrow' => array(
                'label'     => __( 'Arrow', 'phlox-pro' ),
    ...
    //     'description' => __( 'Enable it to replace archive section with an Elementor template.', 'phlox-pro' ),
    ...
    $sections[] = array(
        ...
        'parent'      => 'blog-section', // section parent's id
        'title'       => __( 'Blog Category & tag', 'phlox-pro' ),
        'description' => __( 'Blog Category & tag page Setting', 'phlox-pro' )
    );
    ...
    $sections[] = array(
        ...
        'parent'      => 'blog-section', // section parent's id
        'title'       => __( 'Blog Page Appereance', 'phlox-pro' ),
        'description' => __( 'Blog Page Appereance', 'phlox-pro' ),
    );
    ...
    $options[] = array(
        'title'       => __( 'Override Footer Template', 'phlox-pro' ),
        'description' => __( 'Enable it to replace footer section with an Elementor template.', 'phlox-pro' ),
    ...
    $options[] = array(
        'title'       => __( 'Elementor Footer Template', 'phlox-pro' ),
    ...
    $options[] = array(
        ...
        'default'     => __( "&copy; {{Y}} {{sitename}}. All rights reserved.", 'phlox-pro' ),
        'type'        => 'textarea'
    );
    ...
    $options[] = array(
        'title'       => __( 'Enbale Sticky Footer', 'phlox-pro' ),
