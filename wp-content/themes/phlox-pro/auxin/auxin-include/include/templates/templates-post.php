                ...
                <?php if( $count > 0 ) { ?>
                    <div class="aux-card-dropdown aux-phone-off <?php echo esc_attr( $args['dropdown_class'] ); ?>">
                        ...
                        <div class="aux-card-checkout">
                            ...
                            <span class="aux-card-final-amount-text" > <?php echo __( 'Sub Total', 'phlox-pro' ) ; ?> </span>
                            <span class="aux-card-final-amount-total"> <?php echo $woocommerce->cart->get_cart_subtotal() ;?> </span>
                            </div>
                            <div class="button-wrapper">
                                <a target="_blank" href="<?php echo esc_url( wc_get_checkout_url() ); ?>" class="aux-button aux-large <?php echo esc_attr( $args['color_class'] ); ?> aux-uppercase"><span class="aux-overlay"></span><span class="aux-text"><?php esc_attr_e( 'Proceed To Checkout', 'phlox-pro' ); ?></span></a>
                                <div class="clear"></div>
                                <a target="_blank" href="<?php echo esc_url( wc_get_cart_url() ); ?>" class="aux-button aux-large aux-outline aux- <?php echo esc_attr( $args['color_class'] ); ?> aux-outline aux-uppercase"><span class="aux-overlay"></span><span class="aux-text"><?php esc_attr_e( 'View Cart', 'phlox-pro' ); ?></span></a>
                            </div>
                        </div>
                    </div>
                <?php } else { ?>
                    <div class="aux-card-dropdown aux-phone-off <?php echo esc_attr( $args['dropdown_class'] ); ?>">
                        <div class="aux-card-box aux-empty-cart">
                            <?php esc_attr_e( 'Your cart is currently empty.', 'phlox-pro' ) ?>
                        </div>
                    </div>
                <?php } ?>
            <?php endif; ?>
